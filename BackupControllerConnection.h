#ifndef BACKUPCONTROLLERCONNECTION_H
#define BACKUPCONTROLLERCONNECTION_H

#include "DeviceConnection.h"
#include "ControllerData.h"


class BackupControllerConnection : public DeviceConnection
{
    public:
        BackupControllerConnection();
        virtual ~BackupControllerConnection();
...
#endif // BACKUPCONTROLLERCONNECTION_H
